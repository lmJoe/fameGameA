...
export default new class Api{
    ...
    /**增加次数 */
    gameAddChance(callback){
      ajax({
        type: 'POST',
        url: URL.gameAddChance,
        data: {},
        dataType: 'json',
        // contentType:'application/json',
        success: (response) => {
     ...
     * 看广告上报触发事件
     */
    uploadHideEvent(id,callback){
      ajax({
        type: 'POST',
        url: URL.uploadHideEvent,
        data: {
          id:id,
        },
        dataType: 'json',
     ...
     * 领取奖励
     */
    earnHidePrize(id,ret,callback){
      ajax({
        type: 'POST',
        url: URL.earnHidePrize,
        data: {
          id:id,
          ret:ret,
        },
    ...
    /**播种 */
    gameSeed(fieldId,cropsId,callback){
      ajax({
        type: 'POST',
        url: URL.seed,
        data: {
    ...
    gameHarvest(recordId,callback){
      ajax({
        type: 'POST',
        url: URL.tilllandHarvest,
        data: {
          recordId:recordId,
        },
        dataType: 'json',
    ...
    /**获取主场景 */
    getMainScene(callback){
      ajax({
        type: 'POST',
        url: URL.getMainScene,
        data: {},
        dataType: 'json',
        // contentType:'application/json',
        success: (response) => {
    ...
    getExtSceneInfo(callback){
      ajax({
        type: 'POST',
        url: URL.getExtSceneInfo,
        data: {},
        dataType: 'json',
        // contentType:'application/json',
        success: (response) => {
    ...
    earnTaskPrize(taskId,callback){
      ajax({
        type: 'POST',
        url: URL.earnTaskPrize,
        data: {
          taskId:taskId,
        },
        dataType: 'json',
    ...
    getGardenCropsList(callback){
      ajax({
        type: 'POST',
        url: URL.getGardenCropsList,
        data: {},
        dataType: 'json',
        // contentType:'application/json',
        success: (response) => {
    ...
    getGrowCropsList(callback){
      ajax({
        type: 'POST',
        url: URL.getGrowCropsList,
        data: {},
        dataType: 'json',
        // contentType:'application/json',
        success: (response) => {
    ...
    //气泡信息
    getInfoByLoc(loc,callback){
      ajax({
        type: 'POST',
        url: URL.getInfoByLoc,
        data: {
          'loc':loc,
        },
        dataType: 'json',
