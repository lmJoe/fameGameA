  ...
  onConfigLoaded() {
    Laya.Scene.open(Scenes.StartLoading, true, null, Laya.Handler.create(this, (loadingScene)=>{
      var imgData = [
        ...
        { url: "res/atlas/balloon.atlas", type: Laya.Loader.ATLAS },
        { url: "res/atlas/soilani.atlas", type: Laya.Loader.ATLAS },
        { url: "res/atlas/land.atlas", type: Laya.Loader.ATLAS },
        { url: "homePage/orderBg.png", type: Laya.Loader.ATLAS },
        { url: "homePage/tillArea.png", type: Laya.Loader.ATLAS },
        { url: "homePage/tillBg.png", type: Laya.Loader.ATLAS },
      ];
