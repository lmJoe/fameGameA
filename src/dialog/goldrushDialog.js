...
export default class goldrushDialog extends Laya.Dialog {
  ...
  updateItem(cell, index) {
    ...
    if (cellData.workerID == null) {
      ...
      imgIcon.skin = `newdiggold/mine${iconIndex}-3.png`;
      imgIcon.size(85, 100);
      imgIcon.y = 116;
      ...
      imgIcon.skin = 'newdiggold/worker-half' + workerInfo.level + '.png';
      imgIcon.size(86, 114);
      imgIcon.y = 128;
      lblName.text = workerInfo.name;
      lblInfo.text = '效率：' + workerInfo.coinSpeed + '金币/秒';
      btn.label = data.isLockered ? '购买' : '升级';
      cell.skin=data.isLockered?'newdiggold/box2-2.png':'newdiggold/box2.png';
    ...
    if(nextInfo){
      imgCost.skin = nextInfo.jewelPrice ? 'newdiggold/icon-jewel.png' : 'newdiggold/icon-coin.png';
