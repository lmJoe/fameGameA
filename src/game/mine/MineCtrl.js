...
import { clearCookie, getCookie } from "../../units/units";
...
export default class MineCtrl extends Laya.Script{
    ...
    setProgresss(num, max){
        ...
        if(remainPercent>0){
            ...
            if(remainPercent>=75){
                this.imgMine.skin=`newdiggold/mine${index}-3.png`;
            }else if(remainPercent>=50){
                this.imgMine.skin=`newdiggold/mine${index}-2.png`;
            }else if(remainPercent>=25){
                this.imgMine.skin=`newdiggold/mine${index}-1.png`;
            }else{
                this.imgMine.skin=`newdiggold/mine-none.png`;
            }
            this.imgMineOut.skin=`newdiggold/mine-out${index}.png`;
        }else{
            this.imgMine.skin=`newdiggold/mine-none.png`;
    ...
    setPortrait(index, level){
        this.mineBar.getChildByName('portrait'+(index+1)).skin='newdiggold/worker-portrait'+level+'.png';
    }
