...
import { decrypt, secretKey, getQueryVariable, changeUrlArg } from "./units.js";
...
function ajax (options){
  /**@type {XMLHttpRequest} */
  var xhr = null, retry=0, retryMax=0, retryTime=1000, errMsg='request failed';
